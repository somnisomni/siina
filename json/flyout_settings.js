...
const JSON_FLYOUT_SETTINGS_SYSTEM = String.raw`
{
	"category_domain": "system",
	"category_title": "시스템",
	
	"settings": {
		"disable_page_load_warmup": {
			"default": "0",
			"type": "binary",
			"title": "페이지 로드 시 상호작용 요구 비활성화",
			"description": "Siina의 더 정확한 피아노 연주 동작을 위해 페이지 로드 시 상호작용을 요구하는 창을 표시합니다. 이 설정을 활성화하면 그러한 창을 표시하지 않지만, 부정확한 동작이 발생할 수 있습니다."
		}
	}
}`;
...
const JSON_FLYOUT_SETTINGS_PIANO_ROLL = String.raw`
{
	...
	"settings": {
		"hide_by_default": {
			"default": "0",
			"type": "binary",
			"title": "피아노 롤 기본적으로 숨기기",
			"description": "Siina 실행 시 피아노 롤을 숨긴 상태로 설정합니다."
		},
